...
import {
    ...
    VideoBtnWrap,
    NavigationArea,
    Navigtion} from './case-study-template.style'
                            ...
                            <Row>
                                ...
                                <Col lg={7}>
                                    ...
                                    <MetaBox boxtype="share-box">
                                        ...
                                        <Social {...social}>
                                            <SocialLink path="https://www.twitter.com" label="twitter"><i className="fab fa-twitter"></i></SocialLink>
                                            <SocialLink path="https://www.facebook.com" label="facebook"><i className="fab fa-facebook-f"></i></SocialLink>
                                            <SocialLink path="https://www.linkedin.com" label="linkedin"><i className="fab fa-linkedin"></i></SocialLink>
                                        </Social>
                                    </MetaBox>
                                </Col>
                            </Row>
