...
import HeaderForm from '../../../../components/header-form/layout-one'
import {
    HeaderWrap, 
    HeaderTop, 
    HeaderBottom,
            ...
            <HeaderWrap ref={headerRef}>
                <HeaderTop borderBottom>
                    <Container fluid>
                        <Row>
                            <Col lg={12}>
                                {/*<Text {...textStyle}><Anchor path="/" {...linkStyle}></Anchor> Now Hiring: Are you a driven and motivated 1st Line IT Support Engineer?</Text>*/} 
                            </Col>
                        </Row>
                    </Container>
                </HeaderTop>
